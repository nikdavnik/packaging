...
/bin/cp %{SOURCE2} %{buildroot}/lib/systemd/system/systemd-nspawn@gluu_server_vip_4.0.service
...
ln -s %{gluu_root} /var/lib/container/gluu_server_vip_4.0
...
systemctl stop systemd-nspawn@gluu_server_vip_4.0.service
...
rm -rf /var/lib/container/gluu_server_vip_4.0
rm -rf /opt/gluu-server-vip

%files
%{gluu_root}/*
%attr(755,root,root) /usr/sbin/gluu-serverd-4.0
/lib/systemd/system/systemd-nspawn@gluu_server_vip_4.0.service

%clean
rm -rf %{buildroot}

%changelog
* Tue Apr 02 2019 Davit Nikoghosyan <davit@gluu.org> - 1-1
- new release vip 4.0 
