...
#   wget -nv http://ox.gluu.org/maven/org/gluu/credmgr/credmgr/$VER/credmgr-$VER.war -O $DISTWEB/credmgr.war
    ...
    wget https://ox.gluu.org/npm/passport/passport-4.2.2.tgz -O $DISTWEB/passport.tgz
    ...
    wget https://raw.githubusercontent.com/GluuFederation/community-edition-package/master/package/systemd/fido2.service -O gluu-server/lib/systemd/system/fido2.service
