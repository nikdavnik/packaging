...
Requires:       python3-ldap3, python3-six, python3-ruamel.yaml, python3, python3-PyMySQL, tar, net-tools, apache2, curl, wget, tar, xz, unzip, rsyslog, python3-requests, python3-certifi, bzip2
AutoReqProv:    no
%description
